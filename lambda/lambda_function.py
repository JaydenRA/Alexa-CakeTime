...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Hello! Welcome to this Amazon-Made noobie helper skill. When is your birthday?"
        reprompt_text = "Well? Say something then!"
...
class HasBirthdayLaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if now_date != next_birthday:
            ...
            speak_output = "Waagwan bro. Looks like there are still \
                            {days} days until your {birthday_num}th\
                            birthday man. Dont come back until then.".format(
                                days=diff_days,
...
class CaptureBirthdayIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = 'Cool, I will remember that you were born {month} {day} {year}. At this point I would usually tell you your star sign but I would rather not push more people to the mass cultural delusion that the suns apparent position relative to arbitrarily defined constellations at the time of your birth somehow affects your personality.'.format(month=month, day=day, year=year)
        
        if year == "2006" and month == "April" and day == "10":
            speak_output = 'Cool, I will remember that you were born {month} {day} {year}. Oh wait... Thats the same as mine! Bro thats kinda mad though still.'.format(month=month, day=day, year=year)
